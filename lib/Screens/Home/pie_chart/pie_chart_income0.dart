...
//             if(listItem.category.contains(listItem.category ?? "")){
//
//             }
//           }
//         }
...
//                               Container(width: 85,
//                                 child: Center(
//                                   child: Text("${categoryPercent(expenseIncomeList[index].income ?? 0,
//                                       expenseIncomeService.totalIncome ?? 0).toStringAsFixed(2)} %",
...
//             notchMargin: 8.0,
//            // shape: NotchedShape(),
//             child: Text("Total Income  ${expenseIncomeService.totalIncome}",
