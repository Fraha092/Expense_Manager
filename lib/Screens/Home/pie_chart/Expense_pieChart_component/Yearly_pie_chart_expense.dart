...
class YearlyExpensePieChart extends StatefulWidget {
  const YearlyExpensePieChart({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Container(width: 85,
                              child: Center(
                                child: Text("${categoryPercent(expenseIncomeList[index].expense,
                                    totalChartExpense()).toStringAsFixed(2)} %",
          ...
          BottomAppBar(
            notchMargin: 8.0,
            // shape: NotchedShape(),
            child: Text("Total Expense  ${totalChartExpense()}",
  ...
  void addExpenseIncome({required ExpenseIncome expenseIncome}) {
    ...
    if (isNotEmpty) {
      try {
        ...
        expense.expense += (expenseIncome.expense);

        print("expenses 2 $expenses ${expense.expense}");
      ...
      print("expenses 4 $expenses ${expenseIncome.category}");
