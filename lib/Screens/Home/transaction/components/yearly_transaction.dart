...
class _YearlyTransactionState extends State<YearlyTransaction> {
            ...
            children: [
              Row(
                children: <Widget>[
                  Container(
                    width: 74,
                    child: Center(child: Text('Date',style: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 13))),
                  ),
                  Spacer(),
                  Container(
                    width: 74,
  ...
  Future<void> download() async {
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (pw.Context context )=>[
          pw.Header(text: 'Yearly Transaction\n\n\n',),
          pw.Center(
                    ...
                    children: [
                      pw.Padding(
                          ...
                          child: pw.Column(
                              ...
                              children: [
                                pw.Text('Total Income ${totalIncomes()}\n'),
                                pw.Text('Total Expense ${totalExpenses()}\n'),
                                pw.Text('Balance  ${totalIncomes()-totalExpenses()}\n'),
                              ]
                          )
                      )
                    ]
    ...
    final String path = '$directory/Yearly_Transaction.pdf';
